    ...
    complex<double> & vertex)
{
  //complex<double> cI = complex<double> (0., 1.); 
  complex<double> tmp; 
  VVS11_0(V1, V2, S3, COUP1, vertex); 
  VVS12_0(V1, V2, S3, COUP2, tmp); 
  vertex = vertex + tmp; 
  VVS13_0(V1, V2, S3, COUP3, tmp); 
  vertex = vertex + tmp; 
}
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (-cI * (TMP0 * TMP9) + cI * (TMP3 * TMP7)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP0 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP3 = (V2[2] * P1[0] - V2[3] * P1[1] - V2[4] * P1[2] - V2[5] * P1[3]); 
  vertex = COUP * S3[2] * (-cI * (TMP3 * TMP7) + cI * (TMP0 * TMP9)); 
}
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (+4. * cI * (TMP2) - 4. * cI * (TMP1)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP0 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP3 = (V2[2] * P1[0] - V2[3] * P1[1] - V2[4] * P1[2] - V2[5] * P1[3]); 
  vertex = COUP * S3[2] * (TMP4 * (-cI * (TMP6 * TMP9) + cI * (TMP3 * TMP5)) +
      TMP8 * (-cI * (TMP0 * TMP5) + cI * (TMP6 * TMP7)));
}
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (TMP4 * (-cI * (TMP3 * TMP5) + cI * (TMP6 * TMP9)) + TMP8 *
      (-cI * (TMP6 * TMP7) + cI * (TMP0 * TMP5)));
}
    ...
    complex<double> S3[])
{
  ...
  complex<double> denom; 
  int i; 
  VVS11_3(V1, V2, COUP1, M3, W3, S3); 
  VVS12_3(V1, V2, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
  ...
  VVS13_3(V1, V2, COUP3, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP2 = -1. * (P1[0] * (P2[1] * (V2[5] * V1[4] - V2[4] * V1[5]) + (P2[2] *
      ...
      (V2[4] * V1[2] - V2[2] * V1[4]) + P2[2] * (V2[2] * V1[3] - V2[3] *
      V1[2]))))));
  vertex = COUP * S3[2] * (-cI * (TMP2) + cI * (TMP1)); 
}
