    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S3[2] * (-cI * (V2[2]) + cI * (P1[0] * TMP9 * OM1)); 
  V1[3] = denom * S3[2] * (-cI * (V2[3]) + cI * (P1[1] * TMP9 * OM1)); 
  V1[4] = denom * S3[2] * (-cI * (V2[4]) + cI * (P1[2] * TMP9 * OM1)); 
  V1[5] = denom * S3[2] * (-cI * (V2[5]) + cI * (P1[3] * TMP9 * OM1)); 
}
