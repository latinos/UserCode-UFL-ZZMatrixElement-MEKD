...
#ifndef MG5_Sigma_HEF_UFO_ssx_mummupmummup_H
#define MG5_Sigma_HEF_UFO_ssx_mummupmummup_H
...
class BKG_DN_SF
{
  public:
    ...
    virtual string name() const {return "s s~ > mu- mu+ mu- mu+ (HEF_UFO)";}
...
#endif  // MG5_Sigma_HEF_UFO_ssx_mummupmummup_H
