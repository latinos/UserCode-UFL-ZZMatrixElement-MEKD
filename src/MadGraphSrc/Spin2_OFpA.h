...
#ifndef MG5_Sigma_HZZ_Unitary_gg_Spin2_emepmummupa_H
#define MG5_Sigma_HZZ_Unitary_gg_Spin2_emepmummupa_H
...
class Spin2_OFpA
{
  public:
    ...
    virtual string name() const {return "g g > e- e+ mu- mu+ a (HZZ_Unitary)";}
  ...
  private:
    ...
    double matrix_gg_xg_emepmummupa_no_hzp(); 
...
#endif  // MG5_Sigma_HZZ_Unitary_gg_emepmummupa_H
