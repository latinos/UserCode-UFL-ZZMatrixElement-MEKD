...
#ifndef MG5_Sigma_HEF_UFO_ssx_emepmummup_H
#define MG5_Sigma_HEF_UFO_ssx_emepmummup_H
...
class BKG_DN_OF
{
  public:
    ...
    virtual string name() const {return "s s~ > e- e+ mu- mu+ (HEF_UFO)";}
...
#endif  // MG5_Sigma_HEF_UFO_ssx_emepmummup_H
